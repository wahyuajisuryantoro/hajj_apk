              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildDropdownItem(
                      items: controller.programList,
                      controller: controller.codeProgramController,
                      label: "Program",
                      hint: "Cari program...",
                    ...
                    _buildDropdownItem(
                      ...
                      controller: controller.codeCategoryController,
                      label: "Kategori",
                      hint: "Cari kategori...",
                    ...
                    const SizedBox(height: 16),
                    _buildDropdownItem(
                      items: controller.cabangList,
                      controller: controller.codeCabangController,
                      label: "Cabang",
                      hint: "Cari cabang...",
                    ...
                    _buildImagePicker(
                        'Foto KTP', controller.ktpPicturePath, true),
  ...
  Widget _buildDropdownItem({
    ...
    return Container(
      ...
      child: DropdownSearch<Map<String, dynamic>>(
        ...
        selectedItem: controller.text.isEmpty
            ? null
            : items.firstWhereOrNull(
                (element) => element['code'] == controller.text,
              ),
